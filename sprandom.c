			  ...
			  uint64_t align_bs)
{
	...
	total_alloc += 2 * invalid_capacity * sizeof(uint64_t);
...
/**
 * sprandom_init_rand_state - initialize the random state
 * @info: sprandom_info structure containing state and configuration.
 * @td: fio thread data
 *
 * Returns 0 on success,
 * or a negative error code if system RNG initialization fails.
 */
